...
//import fr.STB1.model.ListFonctionnalite;
...
//		/*
//		 * if(validateXMLSchema("src/main/java/stb.xsd",
//		 * "src/main/java/stb.xml")) System.out.println(
//		 * "Xml valide par rapport au schéma");
//		 * if(!validateXMLSchema("src/main/java/stb.xsd",
//		 * "src/main/java/stb.xml")) System.out.println(
//		 * "Xml pas valide par rapport au schéma");
//		 */
//
//		StbList As = new StbList();
//		ExigenceFonctionnelle c = new ExigenceFonctionnelle("adek", "romaric", 2);
//		ArrayList<ExigenceFonctionnelle> l = new ArrayList<>();
//		l.add(c);
//
